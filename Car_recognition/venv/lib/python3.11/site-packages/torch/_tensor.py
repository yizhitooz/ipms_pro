...
class Tensor(torch._C.TensorBase):
    ...
    def refine_names(self, *names):
        ...
        Examples::
            ...
            >>> imgs_backup = torch.randn(32, 3, 128, 128)
            >>> named_imgs = imgs_backup.refine_names('N', 'C', 'H', 'W')
            >>> named_imgs.names
            ('N', 'C', 'H', 'W')
    ...
    def rename(self, *names, **rename_map):
        ...
        Examples::
            ...
            >>> imgs_backup = torch.rand(2, 3, 5, 7, names=('N', 'C', 'H', 'W'))
            >>> renamed_imgs = imgs_backup.rename(N='batch', C='channels')
            >>> renamed_imgs.names
            ('batch', 'channels', 'H', 'W')

            >>> renamed_imgs = imgs_backup.rename(None)
            >>> renamed_imgs.names
            (None, None, None, None)

            >>> renamed_imgs = imgs_backup.rename('batch', 'channel', 'height', 'width')
            >>> renamed_imgs.names

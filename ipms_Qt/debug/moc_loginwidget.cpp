...
QT_MOC_LITERAL(1, 12, 10), // "level_sent"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "level"
QT_MOC_LITERAL(4, 30, 21), // "unlogin_close_signals"
QT_MOC_LITERAL(5, 52, 13), // "unlogin_close"
QT_MOC_LITERAL(6, 66, 22) // "on_loginButton_clicked"

    },
    "LoginWidget\0level_sent\0\0level\0"
    "unlogin_close_signals\0unlogin_close\0"
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->level_sent((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->unlogin_close_signals(); break;
        case 2: _t->unlogin_close(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::level_sent)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::unlogin_close_signals)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginWidget::level_sent(int _t1)
{
...
// SIGNAL 1
void LoginWidget::unlogin_close_signals()
{
